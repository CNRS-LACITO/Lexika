...
\re
\xv novwu ã i bwayu, e yu mwã mòn
\dialx PA WEM
...
\ge aller en amont d'un cours d'eau ; sortir de l'eau, etc.
\re
\se ã-daa-mi
\dialx GOs
\sge monter vers ici
...
\re
\se ã-du-mi
\sge descends vers moi
\se ã-du-ò
\sge descends en t'éloignant
\xv nu ã-du Frans
...
\ps n
\ge maternels
\dn Ceux qui reçoivent les dons coutumiers lors des cérémonies funéraires.
\re
\dt 23/Feb/2019
...
\lx ala-
\dialx GOs PA BO
\ps n ; PREF. sémantique (référant à une surface extérieure)
\sn 1
\is corps
...
\dn fibre lavée et séchée, sert à faire des cordes pour les frondes, les doigtiers de sagaie ou les ceintures de guerre 'wa-bwanu' (Charles)
\re
\dt 01/Feb/2019
...
\dialx GO
\xn ta marmite est posée de travers (i.e. plus sur un côté, pas au milieu)
\xv kô-alaxe
\dialx GO PA
...
\ge eux-deux là ; hé ! les 2 hommes !
\re
\dt 29/Jan/2019
...
\ge vas-y ! (utilisé lors de la ligature de la paille sur le toit)
\dn Appels prononcés par la personne qui est à l'intérieur de la maison à l'adresse de celui qui est sur le toit pour que ce dernier pique l'alène vers lui, vers le bas)
\re
\cf cabòl !
\ce sors ! (appel de celui qui est sur le toit à l'adresse de celui qui est à l'intérieur de la maison indiquant à ce dernier qu'il doit piquer l'alène à 
travers la paille vers le haut)
\dt 08/Mar/2019
...
\dn (qui vient soutenir les maternels pour offrir les dons coutumiers à ceux qui viennent d'ailleurs ('aavhe'), lors des dons dans les cérémonies (de deuil par ex.)
...
\is insecte
\ps n
\ge termite (lit. qui perce le bois)
\re
\dt 29/Jan/2019
...
\mr a-vwe bulu vient de : a-pe-bulu
\cf a-poxe
...
\is grammaire_direction
\ps v.DIR
\ge aller en montant (sans destination précise)
\se a-wâ-vwe-da
\sge monter comme ça (sans destination précise)
\re
\mr a-vwe-da vient de : a-pe-da
\dt 10/Feb/2019
...
\re
\se a-wâ-vwe-du
\sge descendre comme ça (sans destination précise)
\mr a-vwe-du vient de : a-pe-du
\dt 10/Feb/2019
...
\xv bala trûã !
\dialx GOs
\xn pas de chance (trûã = "faire semblant"; cette expression s'emploie lorsqu'on fait quelque chose qui échoue, et qu'on prétend ne pas avoir voulu faire. La personne elle-même ou quelqu'un d'autre peut le dire)
\sn 2
\is grammaire_modalité
...
\is instrument
\ps n
\ge bâton à glu (sur lequel on colle les cigales)
\dt 27/Jan/2019
...
\ge soeur ou frère du beau-frère ; soeur ou frère de la belle-soeur (désigne aussi 'homme parlant' les cousins parallèles de l'épouse: fils de frère de père, fils de soeur de mère et les cousins croisés de l'épouse: fils de frère de mère, fils de soeur de père)
...
\is parenté
\ps n
\ge cousin croisé de même sexe (terme d'appellation)
\re
\cf ebiigi
\ce cousin croisé de même sexe
\dt 27/Jan/2019
...
\dn Apporte l'eau de la rivière à la tarodière.
\re
\xv lha thu bii
...
\cf huli
\ce manger (de la viande, du coco)
\cf kûûni
\ce manger (fruits)
\dt 26/Jan/2019
...
\dn Se dit par ex. des feuilles d'arbre après un feu.
\re
\re
\cf mènõ
...
\xv e böle mu-cee
\dialx GO
\xn il sent (le parfum de) la fleur (en la prenant)
...
\ps n
\ge arbre (à bois dur)
\dn Son bois fait des étincelles et n'est donc pas utilisé pour le feu de nuit.
...
\dn (au pays des morts, un jeu de balle avec le fruit de l'oranger sauvage permet de distinguer l'esprit d'un vivant de celui d'un mort)
\re
\se pu-buvaa
...
\is classificateur numérique
\ps CLF.NUM
\ge bottes d'herbes et paquets de feuilles (pandanus, etc.)
\re
\se bwa-xe, bwa-tru, bwa-ko, bwa-pa, bwa-ni, etc.
\sge une botte, deux, trois, quatre, cinq, etc.
\xv bwa-xe bwalo-pho etc.
\xn une botte de pandanus, etc.
\xv bwa-xe mae
\xn une botte de Imperata cylindrica
\dt 29/Jan/2019
...
\cf whizi ê ; whal èm [PA] whili èm
...
\dialx GO
\xn son genou
\et *bwaqu 'genou' ; reflet de PSO (proto-S-Oceanic) *bwa-turu 'tête de genou', venant de POc *tunu 'genou'
\eg *bwa-turu 'tête de genou' est reflété dans les langues du S Vanuatu
\dt 15/Feb/2019
...
\dn la tarodière 'bwala' est de taille supérieure à la tarodière 'penu' ; les pieds de taros sont dans l'eau et non plantés sur un billon 'aru', comme c'est le cas pour la tarodière sèche 'penu'.
\re
\se kêê-bwala
...
\ps CLF.NUM
\ge tas de
\xv bwalò-xe, bwalò-tru, bwalò-kò
\dialx GOs
...
\re
\cf kûxû (petit), dròò-kibö (moyen), putrakou (plus gros), bwaô
\ce les 4 noms de la même carangue à des tailles différentes
\dt 29/Jan/2019
...
\sge tête d'igname
\se bwè-mwa
\sge dernière rangée de paille sur le toit (forme un bourrelet qui ferme le faîtage)
\se bwè-po
\dialx BO
\sge casse-tête en bec d'oiseau
\sn 2
\is topographie
...
\is feu
\ps n
\ge pierres (servant de support à marmite)
\dn Ces pierres sont souvent au nombre de trois.
...
\mr bweevwu vient de bwa-puu-n 'à la base'
\sn 2
\is temps_découpage
\ge origine
\xv bwewuu-n
...
\is cultures
\ps n
\ge tête de l'igname (replantée)
\ge bouture d'igname (utilisant l'extrémité inférieure de l'igname)
\re
\an tho-kui
...
\ge jusqu'à
\re
\xv Kavwö jaxa-cö vwö cö zòò ca bwa drau
\dialx GO
...
\va ca-
\ve BO [Corne, BM]
\is classificateur possessif_nourriture
\ps n
...
\se caa-xa kui
\dialx GO
\sge l'accompagnement de l'igname
\dt 04/Feb/2019
...
\is déplacement
\ps INTJ
\ge sortir ; sors ! (utilisé lors de la ligature de la paille et de la couverture du toit)
\dn appels prononcés par la personne qui est sur le toit à l'adresse de celui qui est à l'intérieur de la maison indiquant à ce dernier qu'il doit piquer l'alène et la pousser vers l'extérieru (cabòl!), 
ensuite on crie (a-ò! : pars) pour récupérer l'alène.
\cf a-ò !
\ce pars ! 
\dt 05/Mar/2019
...
\se ce bwòn
\dialx BO
\sge bûche pour la nuit (lit. bois nuit)
\se cee bon
\dialx PA
\sge bûche pour la nuit
\se ce bwo
\dialx GO
\sge bûche pour la nuit
\se ce he
\dialx GO
\sge bois pour allumer le feu (lit. bois frotté)
\se ce cia
\dialx GO
\sge poteau de danse
\se ce-kiai, ce-xiai
\dialx GO
\sge bois pour le feu, pour la cuisine
\se ce ko
\dialx GO
\sge perches (devant la porte) (lit. bois debout)
\se ce kòl
\dialx PA
\sge perches (devant la porte) (lit. bois debout)
\se ce mwa
...
\ge thématisation
\re
\xv da yaaza-cu ? yaaza-nu Kaawo - yaaza-nu ce/je Kaawo
\dialx GO
\xn quel est ton nom ? - je m'appelle Kaawo - mon nom c'est Kaawo
\dt 08/Feb/2019
...
\is feu
\ps v
\ge bois que l'on frotte pour faire du feu
\re
\cf yaa-he
...
\is instrument_pont
\ps n
\ge passerelle ; planche servant de pont pour traverser une rivière (ou posée sur la boue)
\re
\dt 23/Feb/2019
...
\is feu
\ps n
\ge bûche (pour la nuit)
\dn Cette grosse bûche brûle toute la nuit. Elle est portée par les hommes.
\re
\se kô-pa-ce-bò
\dialx GO
...
\dn Voir le livre des plantes du chemin kanak.
\re
\dt 22/Feb/2019
...
\ge bois pour le feu allumé dehors pour se réchauffer
\cf ce-bò ; ce bwo
...
\ps n
\ge sensitive
\dn Cette plante se ferme quand on la touche, d'où "mããni" 'dormir' ; elle a une tige rouge, des feuilles vert-gris et est dotée de petites épines.
\sc Mimosa pudica L.
\re
\dt 15/Feb/2019
...
\ps n
\ge chevrons ; solives
\dn Les solives suivent la pente du toit et supportent les gaulettes qui retiennent la paille.
\re
\cf ce-nuda
\ce solives
\dt 15/Feb/2019
...
\ps n
\ge solives
\dn Les solives supportent les gaulettes qui retiennent les écorces de niaoulis et la paille recouvrant la maison. Ces solives sont plus petites que les solives 'ce-mwa' d'après Dubois.
\re
\cf orèi, zabo
\ce
\dt 15/Feb/2019
...
\ge charpente (maison)
\ge poutre faitîère
\dn Cette poutre rejoint le "pwabwani" au sommet du toit.
\re
\dt 23/Feb/2019
...
\re
\dn Plus petit que "ji, jim", de couleur noire, il s'enfouit dans la terre.
\re
\dt 15/Feb/2019
...
\is instrument
\ps n
\ge tôle (lit. peau/couverture en tôle)
\re
\cf ci-
\ce peau
\dt 27/Jan/2019
...
\el POc
\ea
\ng Forme brève en composition: ci-.
\dt 09/Mar/2019
...
\is fonct.nat
\ps v
\ge toucher ; agacer (un bobo, une blessure)
\re
\dt 08/Feb/2019
...
\re
\dn Se dit du taro et du manioc, quand c'est mal cuit.
\re
\sn 2
\is fonct.intell.
...
\is soin
\ps v
\ge couper (avec des ciseaux, par ex. cheveux, barbe, etc.)
\ge tailler (barbe)
\re
\xv i còòxe pi-hi-n
\dialx PA
...
\xv li pe-còòxe
\dialx PA
\xn ils sont occupés à se couper les cheveux (cette action n'est pas obligatoirement réciproque; elle peut simplement référer à 2 personnes impliquées dans ce processus, dont l'une est celle qui fait l'action de couper)
\xv ã-du mwa còòxe
...
\is bananier
\ps n
\ge banane (à peau grise)
\dn Elle a la forme d'une pirogue et sert à la préparation de "wô" bateau.
\re
\dt 22/Feb/2019
...
\xv da yaaza-cö ? - yaaza-nu Pwayili - yaaza-nu ce/je Pwayili
\dialx GO
\xn quel est ton nom ? - je m'appelle Pwayili - mon nom c'est Pwayili
\xv da yaala-cu ?
\dialx WE
\xn quel est ton nom ? 
\xv da yaala-n ?
...
\is bananier
\ps n
\ge banane (non comestible, dont la sève rouge foncé est utilisée comme peinture de danse)
\re
\dt 10/Mar/2019
...
\dn Il est lancé au sol et constitue le dernier geste coutumier pour le défunt.
\re
\dt 15/Feb/2019
...
\is arbre
\ps n
\ge arbre (et bois qui sent comme le santal)
...
\sn 1
\is mollusque
\ge coquillage servant à couper l'igname (selon Charles)
\sn 2
\is instrument
\ge couteau pour igname (selon Dubois)
\dt 10/Mar/2019
...
\dn pour préparer une purée de cette igname rapée, il faut raper le 'dimwa' dans l'eau de la rivière (voir bwevòlò) pour enlever l'amertume, puis on recueille la chair lavée dans un panier 'keruau', elle est ensuite séchée puis cuite. Se déguste de préférence sucré.
...
\ge sagaie
\se do de
\sge sagaie à 3 pointes (trident)
\se do teò
\sge sagaie de pêche
\se do wexe
\sge 1 sagaie
...
\is crustacés
\ps n
\ge crabe (de creek et de forêt)
\re Tout petit, mesure quelques cms.
\dn
\re
\dt 22/Feb/2019
...
\is plantes
\ps n
\ge épinard (sorte d') ; feuille d'Aramanthus ; brède pariétaire (herbe à feuilles comestibles)
...
\dn Selon Dubois, 1 dopweza de 2,5 m vaut 20 francs.
\sn 2
\is bananier
...
\se drawa dröö
\dialx GO
\sge la suie sur la marmite (litt. suie de la marmite)
\se dawa doo
\dialx BO PA
\sge la suie sur la marmite (litt. suie de la marmite)
...
\is grammaire_modalité
\ps MODIF
\ge faire spontanément (sans savoir, sans penser au résultat)
\xv e draa ne
\dialx GOs
...
\dialx GOs
\xn si cela ne mord pas, tu vas plus bas
\sn 2
\is grammaire_contraste
\ps PRE.VB
\ge tour de (au)
...
\sc (ou) Vitex rotundifolia (Verbénacées)
\re
\dt 15/Feb/2019
...
\is maison
\ps n
\ge lianes (servent à attacher le bois de la charpente)
\re
\dt 15/Feb/2019
...
\dn Petit faucon avec des panaches rougeâtres sous le ventre.
...
\sn 1
\is coutumes_objet
\ge masque (comprenant le tissu/vêtement qui accompagne le masque)
\re
\sn 2
\is maison
\ge chambranles
...
\an kabu ni hêbu
\at la semaine d'avant (il y a longtemps), les semaines passées
\dt 15/Feb/2019
...
\sge tante paternelle et neveu ou nièce
\dt 02/Feb/2019
...
\is grammaire_directionnel
\ps DIR (transverse)
\ge en s'éloignant du locuteur (axe transverse)
\dn Axe transverse d'une vallée à l'autre, traversée d'un cours d'eau.
\re
...
\ve GOs
\ps ANAPH
\ge là ; là-bas (anaphorique référant à des inanimés absents, mais connu des interlocuteurs)
\re
\cf -ò
\ce là Dx2
\cf ã, òli
...
\cf hi-n tòòmwa [PA]
\ce pouce
\cf thizii [GOs], thiri [PA], tiriai-n
\ce auriculaire
\dt 08/Feb/2019
...
\nt epè- indique un couple hétérogène (Haudricourt, Leenhardt), en relation duelle
\dt 10/Mar/2019
...
\dn PA n'utilise "è-pööni-n" que pour la parenté réciproque; "pööni-n" désigne l'oncle maternel.
\re
\xv li è-pööni
\dialx PA
...
\is eau
\ps n
\ge cascade (lit. mélodie de l'eau)
\dn Grosse cascade bruyante.
\re
\dt 05/Mar/2019
...
\is parenté
\ps n
\ge grand-mère (maternelle ou paternelle; terme de désignation et d'appellation)
...
\ps n
\ge tatouage
\dn Fait avec des côtes de palmes de cocotier épointées et incandescentes.
\re
\dt 05/Mar/2019
...
\ps n
\ge igname du chef
\dn Comporte deux espèces: une variété blanche "pwalamu" et une violette "pwang" (selon Dubois).
\re
\cf pwalamu, pwang
\ce
\dt 05/Mar/2019
...
\is arbre_cocotiern 
\ps n
\ge gaine sèche de l'inflorescence du cocotier (après la floraison)
\re
\cf haa-n
\ce ce qui reste
\dt 23/Feb/2019
...
\sn 1
\is instrument
\ge baguette ; canne [Corne]
\re
\sn 2
\is chasse
\ge armature de piège [Corne]
\re
\dt 22/Feb/2019
...
\dialx GO
\xn Non! c'est seulement ma soeur et moi qui sommes parties
\xv Axe za hine-hãdaa-ni xo kani
\dialx GO
...
\ps n
\ge roseau
\ge bambou (petit, pousse au bord de la rivière)
\re
\dt 02/Feb/2019
...
\is grammaire_quantificateur
\ps QNT
\ge il y a beaucoup ; très (lié à "haivwo")
\re
\se hai kãbu
\dialx GO
\sge très froid
...
\se thîni hauva
\dialx GO
\sge enclos (ceint par une barrière où l'on met les dons coutumiers destinés au clan maternel; les oncles maternels démolissent l'enclos et emportent alors les dons ; ne se pratique que pour les personnes de rang important)
\cf mãû bweera
...
\is topographie
\ge bord
\ge extrémité (champ, natte)
\dn Désigne l'extrémité de la natte, là où les fibres dépassent.
\re
\sn 2
\is cultures
...
\xn c'est le chien qui a mordu qui aboie?
...
\se hêgi pulo
\dialx PA
\sge monnaie blanche (faite de coquillages blancs, Charles)
\se hegi mhõõng
\dialx PA
\sge monnaie offerte avec un rameau de n'importe quel arbre, des noeuds sur la cordelette séparent les coquillages blancs enfilés (Charles)
...
\dn Ce terme lexicalisé réfère à toute prise en général sans toujours référer au contenu d'un panier.
\re
...
\dialx GOs
\xn c'est toi qui as pris ces tilapia ?
\dt 23/Feb/2019
...
\dialx BO
\xn ils sont tante et neveux/nièces (enfants de frère)
\nt terme d'appellation : enõ 'tantine'
\sn 2
\is parenté
\ge famille ; allié
\re
...
\xv pe-hê-xòlò-lò
\dialx GO
\xn ils (3) sont de la même famille
\dt 27/Jan/2019
...
\dn pour taper les roussettes ou gauler les grappes de coco.
\re
\xv i henime nu
...
\ps DEM SG
\ge réfère au passé 
\dn Passé plus lointain dans le temps que -ò.
\re
\xv ia je loto hèò ?
\dialx PA
...
\is igname
\ps n
\ge igname longue  [Dubois et Charles]
\re
\dt 23/Feb/2019
...
\is arbre
\ps n
\ge morindier ; fromager (petit arbre)
\dn Arbuste à propriétés curatives; son écorce a aussi des propriétés teinturales, jaune.
...
\ps CLF.POSS
\ps n
\ge nourriture carnée part (de poisson et viande),
\ge ration ; part de sucreries ; médicaments (PA)
\re
\xv ho-ã
...
\is action_corps
\ps v
\ge sortir (de son habitacle) ; exhorbité
\re
\xv e hò pi-mee
\dialx GOs
...
\is grammaire_démonstratif
\ps PRON.DEICT
\ge celui-ci ; de ce côté-ci [BM, Corne]
\re
...
\re
\se bwe hoogo
\sge pic, sommet de la montagne
\se do hoogo ; du hoogo
\sge crête de la montagne
\se ci hoogo
\sge versant
\se hi-hoogo/hi-hoogo
\sge ramification de la montagne
\dt 15/Feb/2019
...
\sn 1
\is instrument_pont
\ge passerelle ; pont (tronc d'arbre ou planche pour traverser une rivière)
\re
\sn 2
\is interaction
...
\is santé
\ps n
\ge mycose (lit. qui mange les gens)
\re
\dt 15/Feb/2019
...
\ge nous deux (inclusif)
\re
\gb
\xv xa îî, avwö mi baani
\dialx GO
\xn et nous, nous avons voulu le tuer
\dt 08/Feb/2019
...
\ge voilà (les) là-bas (en les désignant)
\re
\dt 06/Mar/2019
...
\xn et nous, nous restions chez eux
\dt 29/Jan/2019
...
\sn 1
\is insecte
\ge cigale (petite, à tête verte, vit en forêt)
\re
\sn 2
\is caract.personne
...
\se jiu-ã, jiu-la
\dialx PA
\sge nous ensemble, eux ensemble
\xv phe-jiun
\dialx PA
\xn prend tout
...
\re
\gb
\xv li nhuã mwã ije jivwa la yada kêê-je ma õã-je
\dialx GO
...
\ps n
\ge bancoulier 
\dn On extrait une teinture noire du fruit, cette couleur est l'un des symboles des premiers occupants, des maîtres de la terre et des soutiens de la chefferie.
...
\xv kòlò je-na wamã ka yala-n i Mwèn
\dialx PA
...
\xv kaale pu nu khôbwe-ayu-ni mwã ne ogine teen i ã
\dialx PA 
...
\dn jeu avec deux bâtons: on tape sur une extrémité du bâton avec l'autre bâton et le gagnant est celui qui l'a propulsé le plus loin
\re
\dt 02/Feb/2019
...
\sn 2
\is sentiments
\ge suivre qqn comme son ombre (qqn à qui on est très attaché)
\re
\xv e kãgu-je
...
\is guerre
\ps v
\ge réfugier (se) [Haudricourt, Corne]
\re
\nt non vérifié
\dt 05/Mar/2019
...
\se me-kale
\dialx PA
\sge marée montante (avant de la marée montante, limite de l'eau montante)
\se kaze kou
\dialx GO
\sge marée d'équinoxe de printemps
\se kale kou
\dialx PA
\sge marée d'équinoxe de printemps
\xv i kale
...
\xv ã-mi jö whili-da (è)nè kazubi
\dialx GO
...
\is paniers
\ps n
\ge panier (rond en palme de cocotier)
\dn Il est plus grand que "keruau".
\re
\dt 05/Mar/2019
...
\is action_corps
\ps v
\ge ouvrir une enveloppe (par ex. de bougna)
\re
\dt 23/Feb/2019
...
\ps n
\ge père (désignation)
\ge frère de père ; cousins du père
...
\is paniers
\ps n
\ge panier (en palme de cocotier)
\dn Petit panier rond à anses.
\re
\dt 05/Mar/2019
...
\is paniers
\ps n
\ge panier de charge ; panier porté sur le dos 
...
\sn 1
\is pêche
\ge nasse (à anguilles ou poisson) ; filet (identique au "deaang", mais plus grand, selon Dubois, Corne)
\re
\sn 2
\is maison
\dialx PA
...
\sn 2
\is coutumes
\ge recevoir un geste coutumier (et remercier par un geste en retour)
\re
\dt 05/Mar/2019
...
\ge jeunes feuilles encore roulées sortant du coeur de la plante
\re
\se kiboo ce
\dialx GO
...
\xn se prosterner debout, se prosterner assis
\cf bwagiloo
\ce
\dt 28/Jan/2019
...
\sn 1
\is caract.animal
\ge pas dressé (lit. qui n'a pas de coeur)
\re
\xv kixa ai-je
\dialx GOs
\xn pas dressé
...
\xv kixa ai-je
\dialx GOs
\xn il n'a pas l'âge de raison (enfant) (lit. qui n'a pas de coeur)
\dt 23/Feb/2019
...
\se kô-wãga
\sge couché les jambes ou pattes écartées
\se kô-pa-ce-bo
\dialx GOs
\sge couché près du feu
\se kô-phaa-ce-bon
...
\se e kô-alaxè
\dialx GO
\sge il est couché sur le côté
\se e kô-bazòò
\dialx GO
\sge il est couché en travers de l'entrée
\se la kô-goonã
\dialx GO
\sge ils font la sieste (ou) la grasse matinée (lit. allongé-midi)
...
\re
\mr forme courte de: kô-khi(ni)-yaai (lit. allongé-chauffer-feu)
\dt 02/Feb/2019
...
\re
\nt kawolok 'conque' (langue nêlêmwa)
\dt 06/Oct/2018
...
\ge bord de mer
\re
\xv nooli kòli kaze ; nooli kòli we-za
...
\se kòlò pwèmwa
\dialx PA
\sge ouest (litt. côté de la porte)
\se bwa kòlò
\sge sur le côté
\se kòlò gu-i
\dialx PA
...
\is habillement
\ps v
\ge vêtir (se) ; habiller (s') 
\dn Se dit plutôt des vêtements du bas et des chaussures.
\xv i kòò-da-le pazalõ
\dialx PA
\xn il met son pantalon
\xv kò-da ni je hòbòni-m
\dialx BO
\xn habille-toi !
\xv a kò-dale hòbwòni-m
\dialx BO
\xn va t'habiller !
\xv a kò-dale taî-m
\dialx BO
...
\ps n
\ge liane
\dn Variété de liane dont on mange les fruits légèrement grillés, a un goût de café.
\re
\dt 10/Mar/2019
...
\is mouvement
\ps v
\ge tomber (de qqch. inanimé) ; se répandre
\re
\xv la ku
\dialx GOs
\xn ils sont tombés (d'eux-même)
...
\cf ku-bè ; ku-peena ; ku-pe ; ku-jaa ; ku-cu ; ku-dimwa ; ku-bwaolè ; ku-bweena
...
\dialx GOs
\xn mon chien est perdu
\bw kuau (POLYN) 'young of an animal'
\dt 15/Feb/2019
...
\ps n
\ge igname (variété)
\dn Ignames à petites racines, plantées sur le bord du billon, elles poussent plus vite que celles à racines longues du centre du billon et donnent les premières récoltes ; Charles)
\re
\dt 15/Feb/2019
...
\ps n
\ge igname ronde
\dn Ignames à petites racines, on les plante sur le bord du billon, elles poussent plus vite que celles à racines longues du centre du billon et donnent les premières récoltes; Charles)
\re
\cf kube, zaòl
\ce
\dt 15/Feb/2019
...
\xv nu kueli-jö, nu kweli-jö
\dialx GOs
\xn je te déteste
\ng v.t. kueli (+ animés, pronoms), kuele, kuene (+ inanimés)
...
\ge vrai
\re
\xv fhaa ka ku-gòò, vhaa xa ku-gòò
\dialx GO
\xn parole vraie
\wr B
\is grammaire_modalité
...
\xv pu ku-gòò-nu vwo nu vhaa cai jö
\dialx GO
...
\se caa-nu kui
\dialx GO
\sge mon igname (cuite, à manger) (lit. nourriture-ma igname)
\xv kui-nu
\xn mon igname (tubercule)
\cf nom de différents clones : kui paao ; kui kamôve ; kui pòwa ; kui êpâdan/evadan ; yave ; kajaa ; kora ; kera ; kubwau ; djinodji ; bea ; mwacoa ; zara ; thiabwau ; ua ; papua ; hou ; dimwa
\ce
\et *qupi
\eg
\el POc
...
\re
\mr forme courte de ku-khi(ni)-yaai (lit. debout-chauffer-feu)
\dt 02/Feb/2019
...
\sn 2
\is jeu
\ge figure du jeu de ficelle ("la crevette") [BO]
\re
\et *quɖa(ŋ), *quraŋ
\eg
\el POc
...
\dialx GO PA
\xn regarde la maison sur le côté de l'autre côté là-bas
\dt 08/Feb/2019
...
\is plantes_partie
\ps n
\ge tubercule du taro d'eau (uvha) ; taro d'eau
...
\ge bourgeon
\ge jeunes feuilles (commençant à se déployer)
\re
\dt 23/Feb/2019
...
\ps n
\ge carangue (petite)
\dn (selon les locuteurs, elle est appelée ainsi parce qu'elle 'murmure' (cf kûxû) quand on la sort de l'eau)
\re
\cf dròò-xibö
...
\xv bî gaa kha-gi
\dialx GO
\xn nous on pleurait sans cesse
\xv e a-kha-gi
...
\xv nu xa kha-thoe hii-nu
\dialx GOs
\xn j'ai tendu le bras en même temps
\ng indique une action faite en se déplaçant, en même temps qu'une autre action (notion de simultanéité); s'y ajoute parfois une notion de médiativité (evidential) en association avec un verbe de perception: le préfixe indique alors une perception non voulue, indirecte, faite en se déplaçant
\dt 10/Mar/2019
...
\ps v.stat.
\ge lent
\xv ègu xa a kha-maaçe
\dialx GO
\xn c'est quelqu'sn de lent
\sn 2
\is grammaire_manière
\ps ADV
\ge lentement
...
\xv cheni kha-maaçe-ni cee-jö lai
\dialx GOs
...
\re
\xv bî threi-xa ce vwö e kha-trivwi xo je
\dialx GO
...
\xv xa pe-phu khau wãã
\dialx GOs
\xn il volait au-dessus (de moi) ainsi
\sn 2
\is déplacement
...
\xv e khau-ni nya kobwe xo tagaza
\dialx GOs
...
\is grammaire_modalité
\ps QNT
\ps ATTEN atténuatif (ordre) (forme de politesse)
\ge un peu [GOs]
\xv khi ã-mi nõõli !
\dialx GO
...
\mr forme courte de : khi(ni)-yaai
\dt 15/Feb/2019
...
\ge aîné (frère, soeur) ; deuxième frère aîné [BO]
\re
\xv khoe-n thòòmwa
\dialx PA
...
\is oiseau
\ps n
\ge émouchet bleu (à ventre blanc)
...
\sn 2
\is arbre
\ge faux manguier (utilisé comme poison pour la pêche)
\dn Son fruit contient un noyau très toxique.
...
\re
\xv me nõõli druube ma lhò kovanye-nu dròrò
\dialx GO
\xn mes amis et moi avons vu des cerfs hier
\xv inu ma lhò kovanye-nu me nõõli druube dròrò
\dialx GO
\xn mes amis et moi avons vu des cerfs hier
\se lhò-na
\sge eux trois (dx 3)
...
\re
\xv ẽnõ mãl-ò !
\xn vous les enfants ! (paucal)
\xv êgu mãli-ã, mãli-èni, mãli-òli
\xn (duel) ces 2 personnes-là, ces 2 personnes-là (dx2), ces 2 personnes là-bas
...
\xv tho-raa ma nye pònõ mwa nye
\dialx GO
...
\xv maa-ny (a) caali [ma:ɲ ə ca:li]
\dialx PA
...
\ve BO
\ps n
\ge morceau d'étoffe (fait à partir de la racine du banian)
...
\dialx GO
\xn 1 paquet de 3 ignames/taro/coco ; 2 paquets de 3 ; 6 paquets de 3 , etc.
\dt 09/Feb/2019
...
\re
\se êgu mãli-ã
\sge ces 2 personnes-là
\se êgu mãli-èni
\sge ces 2 personnes-là (dx2)
\se êgu mãli-òli
\sge ces 2 personnes-là-bas
\se êgu mãli-ã-du
\sge ces 2 personnes-là en bas
\se êgu mãla-ã-da
\sge ces 2 personnes-là en haut
\se êgu mãli-ò
\sge ces 2 personnes-là (anaphorique)
\xv li ègu mãli-ã
\dialx PA
\xn ces deux personnes-ci
\cf mãlò-
...
\re
\xv bi/nu ã-du kaaze mãni/mã õã-nu 
\dialx GOs
\xn je suis allé pêcher avec ma mère (le pronom bi est meilleur que nu)
\sn 2
\is grammaire_conjonction
\ge et
\re
...
\dn don coutumier qui accompagne les signes de déclin de la personne jusqu'à sa mort et qui sont offerts au clan maternel (à l'oncle maternel)
\re
\se mãû kura
\dialx PA
...
\dn une femme de chacun des clans de la chefferie portait deux robes l'une sur l'autre, chacune enlevait une robe qu'elle posait sur la femme assise (la soeur de la défunte ou celle qui a pris le nom de la défunte.
\re
\dt 09/Feb/2019
...
\dn feuilles de pandanus "phivwâi" ou de "thra": utilisées pour tresser des nattes
\re
\cf thra ; thral [PA]
\ce pandanus
\dt 02/Feb/2019
...
\ge abeille
\re
\nt hu-ã: notre nourriture carnée.
\dt 05/Mar/2019
...
\is grammaire_comparaison
\ps ADV
\ge tel quel (lit. c'est la même apparence)
\re
\xv za men-a-me
...
\ge provisions de route (froides)
\re
\xv mõã-nu
\dialx GOs
...
\dn enroulées autour des "me-de" pour former la corbeille du poteau central de la case (Dubois).
\re
\nt non vérifié
\dt 16/Feb/2019
...
\is sentiments
\ps v
\ge honte (avoir) (car on n'a pas su conserver la vie, lié au deuil)
...
\xv nu thu mõõxi
\dialx GO
\xn je fais des boutures (lié à la notion de vie)
\xv kixa mõõxi
\dialx GO
...
\dn (lit. maison où l'on se cache)
\re
\dt 16/Feb/2019
...
\se mwa pho 
\dialx GO
\sge la maisonnée (lit. maison-tressage), les femmes et enfants
\xv mwa za ? - mwa dili
\dialx GO
...
\se kica mwa
\sge paroi de maison
\ng la forme déterminée est: mõ(õ)
\et *Rumaq
\eg
\el POc
\ea
...
\re
\se phai walei mwa-çii
\sge cuire l'igname (sucrée) avec la peau
\mr mwa-cii (ou) mwa-çii (lit. maison-peau)
\dt 16/Feb/2019
...
\is igname
\ps n
\ge igname ronde (clone) [Dubois et Charles]
\re
\dt 16/Feb/2019
...
\ge demi-tour (faire) ; revenir sur ses pas ; retourner (s'en)
...
\dn Cette préparation est enveloppée et cuite dans des feuilles de canne à sucre ou de cordyline sauvage (di).
\re
\se mwetre chaamwa
\dialx GO
\sge banane rapée
...
\is eau
\ps n
\ge bulles d'air (à la surface de l'eau)
\re
\dt 22/Feb/2019
...
\xv mwêêno mhãi vwo nu kibao-je !
\dialx GOs
\xn il s'en est fallu de peu que je ne le touche
\xv mhãi-ny
\dialx PA
\xn mon morceau
\xv mhãi ti/ri ?
...
\xn un morceau pour qui ? - c'est son morceau
\dt 02/Feb/2019
...
\re
\xv za mhaza nòòli xo je nye êmwê
\dialx GOs
...
\re
\xv mhaza u ka thoe hi-je
\dialx GOs
\xn juste au moment où elle se penche (u) et en même temps tend son bras
\sn 5
\is grammaire_aspect
\ge en train de [BO]
\re
...
\re
\xv mhenõõ-yu-w-a kãgu êgu ma la mã
\dialx GOs
...
\is grammaire_quantificateur
\ps n.QNT
\ge ce qui s'ajoute à un lot (de dons coutumiers)
\dn Mais ne peut constituer un tas complet à lui seul.
\re
\xv mãè-xe xo mhõdòni
\dialx GO
\xn 1 lot de 3 ignames et quelques (i.e. et 1 ou 2 ignames en plus)
\dt 05/Mar/2019
...
\ps OPT
\ge optatif
\dn Exprime un ordre, un conseil, un souhait.
\re
...
\is outils
\ps n
\ge bout de verre (utilisé pour entailler, couper)
\re
\dt 16/Feb/2019
...
\ng La forme déterminée est : ninga
...
\dn C'est aussi une espèce d'arbre dont on utilisait une partie du tronc et le début des racines coupées en pointe, selon Dubois.
\nt non vérifié
\dt 16/Feb/2019
...
\sge perche signalant un interdit
\se nõbu thoomwã
\sge geste donné en signe de fiançaille d'une jeune-femme
\se na nõbu
...
\dn sorte de sablière tenant les gaulettes verticales "me-de" et les chevrons "ce-mwa" du sommet du poteau central "nigol" de la maison ronde (Dubois) ; lit. cou de la marmite
\re
\dt 26/Jan/2019
...
\se ku-nõgò
\dialx GO
\sge source de rivière
\se phwè-nõgò
\dialx GO
\sge embouchure de la rivière
\se phwè-nõgò
\dialx PA
\sge confluent d'un creek dans un fleuve
\se pwò-nõgo
\dialx BO
\sge petite vallée
\xv ni nõgo jaaòl
...
\xv ezoma e, no-me zo tree mònõ
\dialx GOs
\xn ce serait bien s'il fait beau demain
\ng no-me est la forme courte de : novwo na khobwe
\dt 09/Feb/2019
...
\ng nõ-na est la forme courte de : novwö na
\dt 16/Feb/2019
...
\dialx GOs
\xn alors que ces deux-là (les parents) appellent, alors elle, cette Mwani-mi, elle sort de la maison
\xv xa novwö (e)xa whamã mwa ã ẽnõ-ò
\dialx GOs
...
\is arbre
\ps n
\ge palmier calédonien (à croissance rapide)
\re
\dt 29/Jan/2019
...
\dialx GO PA
\xn ne bouge pas !
\nt "nyamã" en GOs n'a que le sens de 'bouger'
\sn 2
\is action
\ge travailler ; travail
\dialx PA BO
...
\mr nyõli est la forme courte de nye-õli
\dt 09/Feb/2019
...
\dialx GO
\xn ses excréments
\ng La forme déterminée ou en composition est nho-
\dt 20/Feb/2019
...
\re
\se pwepwede nhe
\sge virer de bord par vent arrière
\se nhewa-wô
\dialx GO
...
\dialx BO
\sge bateau à voile
\ng La forme déterminée est : nhe(w)a-
\et *layaR
\eg voile
\el POc
\dt 14/Mar/2019
...
\dn Cette partie supérieure avec les lianes est replantée après le prélèvement du bas du tubercule.
\re
\ng ńhome (v.t.)
...
\xv e nhõõ-m
\dialx WEM WE
\xn bien fait pour toi ! (lit. ta crotte)
\xv i nhõ-n !
\dialx PA BO
...
\ng La forme déterminée est: nhõõla-
\dt 14/Mar/2019
...
\is coutumes
\ps n
\ge coutumes accompagnant le déclini de la vie
...
\ge nid de roussette (endroit où les roussettes se posent de jour)
\re
\dt 06/Mar/2019
...
\se e trêê-ò
\dialx GO
\sge il partit en courant
\se ã-ò !
\sge va-t-en !
\se ã-du-ò !
\sge descend (en s'éloignant) !
\xv tia-ò !
\xn pousse!
\xv tia-da-ò !
...
\dialx BO
\xn la mère de Paul
\ng la forme déterminée est: õã- [ɔ̃ɛ̃] ou õõ-
\dt 14/Mar/2019
...
\xv jö ògi ã-du Frans ?
\dialx GO
\xn es-tu déjà allé en France ?
\xv e uvwi-ògine-ni a-xe êgu xè pò-mã
\dialx GO
\xn il a acheté 20 mangues
\xv nu ògi hovwo
\dialx PA
...
\re
\xv e pwe, ògi e thuvwu phai nõ
\xn il a pêché, puis il a lui-même cuit le poisson
\xv e pweni nõ, ògi e thuvwu phai
\xn il a pêché le poisson, puis il l'a cuit lui-même
\et *qoti
\eg finir
\el POc
\ea
...
\se i pa-tha
\dialx PA
\sge il est totalement chauve
\se pa-whaa
\dialx GO
\sge très gros
\mr forme courte de 'para' très
\cf para
\ce très
\ng mhã : 'très'
\dt 14/Mar/2019
...
\ps n
\ge quartz
\dn Pierre blanche et dure, utilisée pour les fours.
\re
\dt 17/Feb/2019
...
\ps n
\ge schistes
\ge pierre rouge (frappée pour produire des étincelles) 
\dn Elle sert à allumer le feu selon Corne.
\dt 05/Mar/2019
...
\sn 2
\is cordes
\ge torsader, tresser une corde à plusieurs brins
\ge corde à plusieurs brins (faire une)
\re
\se pai wa
\dialx GOs
...
\dn Cette plante pousse au ras du sol et fait des petites fleurs bleues. La décoction des feuilles et tiges sert de purge pour les bébés ; elle est aussi utilisée pour annoncer la naissance d'un enfant à son oncle maternel: on offre une tige de cette plante liée à une sagaie (pour un garçon) ou à une écorce de niaouli (pour une fille).
\re
\nt non vérifié
\cf hmahmulim (langue nemi) mitre (langue d'ouvea)
\dt 05/Mar/2019
...
\is pêche
\ps v
\ge faire du bruit dans l'eau avec les mains pour effrayer les poissons
\dn Geste analogue à celui fait pour le jeu "thathibul"
\re
\dt 05/Mar/2019
...
\lx pa-phuu-ni
\ph 'pa-pʰu:-ɳi (accent sur initiale)
\dialx GOs
\is action
\ps v
\ge gonfler qqch
...
\ng ne s'utilise qu'en référence à des humains/animés; mhã s'utilise pour des inanimés
\dt 14/Mar/2019
...
\is configuration
\ps n
\ge trou d'eau (dans une rivière ou la mer)
\re
\dt 17/Feb/2019
...
\sn 3
\is grammaire_dispersif
\ge dispersif ; sans but (activité atélique)
\re
\xv li u a-da mwa a-ve-hale na lina pwamwa
\dialx PA
\xn ils s'en retournent dans leur terroir respectif
...
\dialx GO
\xn ils étaient par cinq dans la (même) voiture
\dt 17/Feb/2019
...
\is grammaire_distributif
\ps DISTR
\ge à combien (d'êtres humains) dans chaque x ?
\re
...
\is grammaire_distributif
\ps DISTR
\ge à combien (d'objets) dans chaque x. ?
\re
\dt 10/Feb/2019
...
\re
\xv li pe-kueli-li ui nye thoomwã xo lie meewu xa êmwê
\dialx GOs
...
\dialx GO
\xn je veux t'accompagner / je veux que nous 2 y allions ensemble
\xv ai-nu wo pe-mhe-õ
\dialx GO
\xn je veux vous accompagner vous2 / je veux que nous 3 y allions ensemble
...
\cf mhe, mhenõ
\ce déplacement
\mr mhe est la forme courte de mhenõ
\dt 10/Feb/2019
...
\ps v
\ge planer
\dn Dans son emploi métaphorique, il réfère à qqn qui paresse.
\re
\xv novwu ã i baro, e pe-na-hi-n bwa dèèn
...
\xv la pe-ne-zo-ni vha-raa xo la êgu
...
\re
\xv la paree nai je wha-mã
\xn ils ont délaissé le vieux (ils ne s'en sont pas occupés)
\dt 14/Mar/2019
...
\re
\xv li pe-pha-nonomi xo Kaavwo ma Hiixe la mwêêje ẽgõgò
\dialx GOs
\xn Kaavwo et Hiixe se rappellent mutuellement les coutumes d'antan
\xv li pe-pha-nonomi çai li la mwêêje ẽgõgò
\dialx GOs
\xn elles se rappellent mutuellement les coutumes d'antan
\xv li pha-nonomi la mwêêje ẽgõgò xo Kaavwo ma Hiixe
\dialx GOs
...
\is position
\ps v
\ge couché sur le ventre (étape de l'évolution d'un bébé)
\re
\dt 10/Feb/2019
...
\xv bi pe-thu-menõ mãni ãbaa-nu xa thõõmwa
\dialx GOs
\xn j'ai fait le chemin avec ma soeur
\xv li pe-thu-menõ (bulu) xo Kaavo ma Hiixe
\dialx GOs
...
\is grammaire_modalité
\ps MODAL
\ge en vain ; sans résultat ; tant pis ! ; ce n'est pas grave
\re
\xv nu môgu ni peu
\dialx GO
...
\is action.tête
\ps v
\ge claquer des lèvres en signe de mépris [Corne]
\dt 24/Jan/2019
...
\sn 2
\is poisson
\ge frai ; oeufs (crustacés) ; laitance (poisson)
\re
\se pi-a nõ
\dialx GOs
\sge oeufs de poisson
\se pi-pwon
\dialx PA
\sge oeuf de tortue
\cf êgo
...
\is corps
\ps n
\ge omoplate (lit. carapace-coeur)
\re
\xv pi-ai-nu
\dialx GOs
\xn mon omoplate
...
\ps v
\ge pousser le feu
\dn Sous la marmite, ou dans la maison ; moins fort que 'carûni'.
\re
\gb
\cf tha-carûni
\ce pousser le feu
...
\sn 2
\is instrument
\ge râpe (faite d'une valve de coquillage)
\dn Utilisée pour gratter le coco, la banane, etc.
\re
\dt 17/Feb/2019
...
\ge rendre visite
\re
\xv eniza nye çö thaavwu pîînã-du ebòli bwaabu ?
\dialx GOs
\xn quand es-tu allée en France pour la première fois ?
\se pe-pîînã
\sge se promener
...
\sn 2
\is instrument
\ge râpe ; grattoir (faite d'une valve de coquille saint-jacques)
\dn Utilisée pour gratter le coco, la banane, la papaye, etc.
\re
\dt 05/Mar/2019
...
\is crustacés
\ps n
\ge crabe plein ('double peau')
\dn Ce mot réfère au moment où la carapace dure se détache et la nouvelle carapace molle se forme.
\re
\dt 17/Feb/2019
...
\ps n
\ge sauterelle
\dn Cette sauterelle à pattes rouges et au corps jaune fait un bruit de crécelle.
\re
\dt 17/Feb/2019
...
\re
\se a-piyuli
\sge qui cherche toujours des querelles, qqn qui a toujours des reproches
\se pe-piyuli
...
\re
\xv po-xè (1); po-tru (2); po-ko (3); po-pa (4), etc.
\dialx GOs
...
\ps n
\ge papillon de nuit
\dn Ce papillon marron et duveteux se nourrit de fruit.
\re
\et *mpompoŋ
\eg
\el POc
...
\dn Elle est faite avec les racines de bourao, sert de monnaie et a plus de valeur que 'wepoo'. Elle faisait plusieurs fois le tour du bassin et se portait au-dessus de 'wepoo'. (Dubois ms et Charles )
\re
\cf thabil [PA]
...
\is déplacement
\ps n
\ge trace (laissée par un animal ou une personne qui y a dormi)
\re
\xv pobo-n
\dialx PA
\xn ses traces
...
\is natte
\ps n
\ge natte (pour couvrir le toit)
\dn Utilisées pour couvrir le toit, elles sont faites de deux demi palmes de cocotier.
\re
\et *mpola
\eg
\el POc
...
\is temps_atmosphérique
\ps n
\ge buée (lit. fruit de saison froide)
\re
\dt 17/Feb/2019
...
\is eau
\ps n
\ge tourbillon d'eau (petit et rapide)
\re
\cf niilöö
...
\se pu bwaa-je
\dialx GOs
\sge ses cheveux (il faut spécifier la partie du corps)
\xv pu-n
\dialx PA
...
\is classificateur numérique
\ps CLF.NUM
\ge pieds d'arbre, feuilles, tubercules, racines
\re
...
\ge biens personnels d'un défunt (remis à sa parenté maternelle)
\re
\dt 17/Feb/2019
...
\xv mii mwa dili, puni nye e mwani mii mwa jena
\dialx GO
\xn la terre devient rouge, du fait que c'est de l'argent rouge cela
\xv e thô pune nu
\dialx GOs
...
\xv ma nye za kòi-nu na ênè avwõnõ, pu-nyeda a khilaa-je
\dialx GO
\xn la raison pour laquelle je n'étais pas ici à la maison, c'était parce que je suis parti la chercher
\dt 10/Feb/2019
...
\dialx GOs
\xn 2 choses
\xv bi pweexu pwaixe na ni vhaa zuanga
\dialx GOs
...
\is igname
\ps n
\ge igname du chef (variété blanche)
\re
\cf gu-kui
\ce igname du chef
\cf pwang
...
\ps n
\ge monnaie
\dn de valeur moindre que 'yòò' et 'weem', mais de valeur équivalente à 'yhalo' (selon Charles). Dubois : 1 pobwanu de 5 m vaut 10 fr). Hiérarchie des valeurs : yòò > weem > yhalo
\re
...
\is igname
\ps n
\ge igname du chef (variété violette)
\re
\cf gu-kui
\ce igname du chef
\cf pwalamu
...
\dialx BO
\xn il ne peut pas nous suivre 
\xv pwawa ne çö whili-mi lãnã pòi-m ?
\dialx WEM
...
\is plantes
\ps n
\ge pandanus sauvage (de bord de creek)
\dn Les feuilles de ce pandanus servent au tressage ; les roussettes mangent ses fruits.
\re
\dt 18/Feb/2019
...
\dn Ces feuille de pandanus, débarrassées de leurs piquants, sont prêtes pour le tressage.
\re
\xv la thu pho
...
\dn et effrayer le poisson pour les pousser dans le filet.
\re
\se thi-pholo
...
\sn 1
\is action.plantes
\ge arracher (à la main des herbes ou des plantes à racine : kumala, kuru, etc.)
...
\ng forme déterminée : phwè- 'trou de'
\dt 23/Mar/2019
...
\se i ta-ò ta-mi
\dialx PA
\sge il va et vient, il fait les cent pas
\dt 23/Mar/2019
...
\is cultures
\ps v
\ge replier la tigne d'igname sur elle-même
\dn quand elle dépasse la hauteur du tuteur [Corne].
\re
\nt non vérifié
\dt 18/Feb/2019
...
\dn i.e. enlever le bois du feu et éparpiller les braises [BM, Corne]
\re
\nt non verifié
\dt 23/Mar/2019
...
\se Teã-ma
\dialx BO PA
\sge grand-chef (et les clans alliés)
\se poxa-Teã
\sge petit-chef
\dt 23/Mar/2019
...
\xv ti thoomwã ne jö kha-whili-je na
\dialx GO
...
\xn une grappe de tomates (lit. une grappe grappe de tomates; tibö ne s'emploie pas au-delà de 'un')
\dt 23/Mar/2019
...
\sn 1
\is caract.objet
\ge épais ; emmêlé ; inextricable ; embrouillé
...
\sn 3
\is coutumes
\ge difficultés (liées aux cérémonie funéraires)
\dn réfère aux perturbation de l'ordre social, selon D. Bretteville.
\dt 23/Mar/2019
...
\is chasse
\ge bâton à glu
\dn Bâton enduit de colle provenant du fruit du gommier, ce bâton est utilisé pour attraper les cigales en leur collant les ailes.
\re
\dt 19/Feb/2019
...
\ge donner un coup
\re
\xv i tò je doo-n, tò-kòòl ni wèngè-n
\dialx BO
...
\is grammaire_contraste
\ps PRE-VB.
\ge contraste (entre deux agents, deux moments, deux actions dont l'une est antérieure)
\re
...
\cf thaavwu ; teevwuun, thaavwun [PA]
...
\ge pendu ; accroché
\re
\ng tre : marque d'état, fait déjà accompli
\cf chôô
...
\re
\xv li pe-cimwî hi, li pe-cimwî hi-li
\dialx PA
\xn ils se serrent la main
\xv waya me tee-yimwî pwaji ?
\dialx BO
...
\mr forme courte de tre-khini-yaai (assis-chauffer-feu)
\dt 10/Feb/2019
...
\ge rester
\re
\xv na jö tree-ku hõbwo-nu
\dialx GOs
\xn et toi tu resteras là à m'attendre
\dt 23/Mar/2019
...
\dn (lit. assis-étaler jambes-nos)
\re
\dt 22/Feb/2019
...
\dialx GOs
\sge quinze
\se truuçi bwa pòni-ma-xe
\dialx GOs
\sge seize
\se truuçi bwa pòni-ma-dru
\dialx GOs
\sge dix-sept
\se truuçi bwa pòni-ma-gò
\dialx GOs
\sge dix-huit
\se truuçi bwa pòni-ma-ba
\dialx GOs
\sge dix-neuf
\se tuuyi bwa pòxè
\dialx PA
...
\dialx PA
\sge quinze
\se tuuyi bwa pònima-xe
\dialx PA
\sge seize
\se tuuyi bwa pònima-du
\dialx PA
\sge dix-sept
\se tuuyi bwa pònima-gòn
\dialx PA
\sge dix-huit
\se tuuyi bwa pònima-ba
\dialx PA
\sge dix-neuf
\dt 19/Feb/2019
...
\va thãã
\ve BO
\is discours_interpellation
\ps INTJ ; appel respectueux à une pers.
\ge hé dites! (à des personnes)
\re
\xv thaam !
\xn dites-moi !, écoutez !
\dt 28/Jan/2019
...
\is action_corps
\ps v
\ge ouvrir (maison, boîte, marmite, etc.)
...
\cf drògò
\ce masque
\cf throo-mwa [GOs] ; thoo-mwa [PA BO]
\ce flèche faitière
\dt 26/Jan/2019
...
\ge épointer
\ge éplucher (en taillant avec un geste orienté vers l'extérieur)
\re
\dt 23/Feb/2019
...
\ps n
\ge mulet de rivière
\dn Mulet juvénile, il remonte le cours des rivières, puis devient "naxo" à l'âge adulte. 
\re
\et *(s,d)aud
\eg
\el POc
...
\is feu
\ps v
\ge allumer un feu de brousse (lit. piquer le feu) ; mettre le feu
\dn Allumer un feu de brousse avec des palmes de coco secs ou des brindilles enflammées.
...
\dn Peler avec un couteau des légumes, ignames ou taros crus, des fruits.
\re
...
\is feu
\ps v
\ge éteint (être) ; éteindre (un feu en tapant)
\re
\se thi-bööni yai
\dialx GO
\sge éteindre le feu en tapant
\xv a bo nuua-n
\dialx BO
...
\dn tout ce qu'on utilise pour faire la monnaie (coquillage, poils de roussette, etc.)
\re
\dt 23/Mar/2019
...
\is cultures
\ps v
\ge planter des palmes de cocotier ou des branches d'autres arbres dans le sol
...
\re
\xv thiiphuu thahulò
\xn à ton tour d'en ajouter un autre (formule utilisée pour les contes)
\dt 23/Mar/2019
...
\dn Enclos ceint par une barrière où l'on met les dons coutumiers destinés au clan maternel; les oncles maternels démolissent l'enclos et emportent les dons ; ceci ne se pratique que pour les personnes de rang important.
\dt 19/Feb/2019
...
\ge bernard-l'ermite (qui se met dans la coquille du 'thooli')
...
\dialx PA
\xn il l'a mal coupé
\ng En composition, thaa se prononce [ra:] ; forme transitive: -raa-ini
\et *(n)saqa(t)
\el POc
\dt 24/Mar/2019
...
\is poisson
\ps n
\ge loche (de rivière, de grande taille)
...
\is plantes
\ps n
\ge érythrinier à piquants (à fleurs rouges)
\re
\se mu thre-mii
\dialx GOs
...
\is poisson
\ps n
\ge picot (de palétuvier, remonte les rivières) ; poisson-papillon
\re
\dt 05/Mar/2019
...
\sge drap
\se pa thrô
\sge faire une natte ; faire un noeud
\dt 19/Feb/2019
...
\is maison
\ps n
\ge décorations sur la flèche faitière de la maison 'throo-mwa' (conques etc)
\re
\dt 26/Jan/2019
...
\is action.plantes
\ps v
\ge faire des boutures (lié à la notion de vie)
\re
\xv nu thu mõõxi
\dialx GO
...
\is cultures
\ps v
\ge faire un trou (pour les cultures, etc.)
\dt 26/Jan/2019
...
\re
\se pa-thu-me-ni
\sge arborer qqch, faire remarquer qqch
\dt 19/Feb/2019
...
\se thu-menõ-hayu 
\dialx GOs 
\sge aller sans savoir où, sans direction; aller à contrecoeur, en se forçant
\se thu-menõ lòlò 
\dialx GOs 
...
\xv e thuvwu tròròwuu ui je (ou) e thuvwu tròròwuu [faux *e thuvwu tròròwuu-je]
\dialx GOs
\xn il est content de lui-même
...
\ge pencher (se)
\ge baisser (se)
\ge courber (se) (par ex. pour entrer dans une maison)
\re
\se u-du !
\sge baisse-toi !
\se u-da !
...
\ps n
\ge poutre sablière
\dn Poutre circulaire supportant la charpente des cases rondes (Dubois).
\re
\nt mot non vérifié
\dt 20/Feb/2019
...
\se u-pwa, u-du-pwa
\dialx GOs
\sge se baisser pour sortir (pwa: dehors)
\dt 24/Mar/2019
...
\xv pune meedree 
\xn à cause du temps (mais *ui meedree)
\cf pexa, pune
\ce à cause de
\dt 24/Mar/2019
...
\sn 1
\ps n
\ge échenilleur Pie (donne des nouvelles)
...
\sge champ de taro
\se zò-uva
\sge rejet de taro annexes (poussent autour du pied principal)
\dt 23/Feb/2019
...
\sn 2
\is coutumes_objet
\ge noeud (fait avec une herbe, signale un interdit, protège des magies)
\re
\dt 05/Mar/2019
...
\is grammaire_IS
\ps focus 
\ge focalisation du sujet pronominal (pronom indépendant) des verbes actifs 
\re
...
\ng xo (est utilisé avec la même fonction)
\dt 20/Feb/2019
...
\dialx GO
\xn Serait-il possible que tu m'emmènes, pour que ja la voie ?
\dt 29/Jan/2019
...
\se gu-wa-alaxò
\dialx GOs
\sge lacet (gu: piquer comme une filoche)
\se pha-wal
\dialx PA
\sge attacher
...
\is classificateur numérique
\ps CLF.NUM
\ge lot de 2 roussettes ou notous (lots cérémoniels)
\re
...
\dialx GOs
\xn fais-le ainsi !
\xv e wã mwa xo Kaawo : "ko (= kawa, kawö) ço nõõli pòi-nu ?"
\dialx GOs
\xn Kaawo fait/dit : "tu n'as pas vu mon enfant ?"
\xv axe wã xo dòny
\dialx GOs
\xn mais la buse fait ainsi
\xv i wã : "kawu jo nõõli ja pòi-ny?"
\dialx PA
...
\se e a wãã-mi
\sge il est allé vers ici
\se e a wãã-ò
\sge il est allé vers là-bas
\se e a wãã-è
\sge il est allé dans une direction transverse
\se e a wãã-da
\sge il est allé vers le haut
\se e a wãã-du èbòli 
\sge il est allé vers le bas là-bas [* e a wãã-du bòli]
\se e nò-wã-du
\sge elle regarde vers le bas
\se e nò-du
\sge elle regarde en bas
\dt 20/Feb/2019
...
\dialx PA
\xn persister à
\xv ha peve waaju kôbwe ha tooli dè-ra mwani
\dialx PA
...
\is coutumes_objet
\ps n
\ge ceinture faite en fibre d'écorce de banian ou 'alamwi'
\dn Elle est tressée de 3 brins de paille ou de feuilles de pandanus. On y mettait les pierres et les paquets magiques pour la guerre. C'est aussi le signe du départ en guerre (Dubois ms).
\re
\dt 22/Feb/2019
...
\is crustacés
\ps n
\ge crabe dont la carapace est nouvelle
\re
...
\re
\xv e wa-me ne khõbwe (e) novwö na li tho ilie-bòli, ça e chaaxö ã we-zumee-je
\dialx GOs
\xn Elle a fait en sorte que, quand ils appellent les deux (parents) en bas, sa salive réponde
\xv wa-me ne e tia-wãã-le da
\dialx GO
...
\ge comme si
\re
\xv i nee hye wa-mèèn exa yo phããde
\dialx BO
...
\cf a-kaalu
\dialx GO
\ce maternels (dans les cérémonie de deuil)
\dt 27/Jan/2019
...
\ps n
\ge racine de
\dn Forme composée ou déterminée de wa(l) 'racine'.
\re
\se we bumi
...
\dn Objets longs tels que voiture, bateau, arbre couché, poteau.
\ge CLF des années, mois
\ge CLF des chants
\re
\xv wè-xe ka ; wè-tru mhwããnu ; wè-ko ka ; wè-pa ka, etc.
\dialx GOs
\xn un an ; deux mois ; trois ans; quatre ans, etc.
\xv wè-ru tèèn
\dialx PA BO
\xn deux jours
\dt 20/Feb/2019
...
\is coutumes_objet
\ps n
\ge monnaie (de moindre valeur que 'yòò')
\re
\dn monnaie faite de coquillages blancs, offerte attachée à un rameau de niaoulis ou de bananier. L'autre nom de cette monnaie est 'hègi pulo'. (Dubois :1 weem de 5 m vaut 100 fr). Hiérarchie des valeurs : yòò > weem > yhalo.
...
\dialx GOs
\xn je pense qu'il est passé par là
\xv nu weena khõbwe e a-è ẽnõli
\dialx GOs
\xn je pense qu'il est passé par là
\xv kavwö me wero, pu nye me weena me ezoma la bòzi-me
\dialx GOs
\xn nous n'avons pas fait de bruit, parce qu'ils nous auraient punis à coup sûr
\xv nu pe-weena
\dialx GOs
...
\dn (lit. racines de la montagne < wal)
\re
\dt 23/Feb/2019
...
\dn Lit. we-pòò 'racine de bourao'. Faite de racine de bourao, elle sert de monnaie à bas prix et est offerte roulée (Charles). Selon Dubois (ms), cette ceinture faisait plusieurs fois le tour du bassin.
\re
\cf pobil, thabil
\ce ceinture de femme (monnaie)
\dt 22/Feb/2019
...
\is eau
\ps n
\ge eau morte ; eau stagnante (lit. eau assise)
\re
\dt 10/Feb/2019
...
\dn Ouverture d'eau des talus externes de tarodière ; elle peut être fermée par de la terre, des pierre ; elle permet de faire passer l'eau de l'étage supérieur à l'étage inférieur de la tarodière (Dubois).
\dt 20/Feb/2019
...
\xv wè-niza wõ xa çö nõõli ? - ca wè-xèè nõ wõ - ca wè-tru wõ xa nu nõõli
\dialx GOs
...
\is action_corps
\ps v
\ge étrangler (serrer le cou) ; pendre
\re
\dt 24/Mar/2019
...
\se whaza-nu ê
\dialx GOs
\sge ma part de canne à sucre
\se whala-n
\dialx PA
\sge sa part de canne à sucre
\ng classificateur possessif : whala-n [PA], whaza-je [GOs]
\cf w(h)ili [PA], whizi [GOs]
...
\sn 1
\is grammaire_interrogatif
\ge comment (être, faire) ?
\dn Aussi utilisé pour les propriétés physiques.
\xv e whaya phago ?
\dialx GOs
\xn quelle est sa couleur ?
\xv êmwê xa whaya ?
...
\is temps_saison
\ps n
\ge mois lors duquel les champs d'ignames sont labourés et plantés
\dn Période d'août à septembre [Dubois].
\re
\cf pweralo, pwebae
\ce
\nt non vérifié
...
\xv nome çö tròòli xa, çö thomã-nu
\dialx GOs
\xn si tu en trouves, tu m'appelles
...
\xv kavwö jö trõne nye ẽnõ-zòòmwa ge-je (ni) xa bwa drau
\dialx GOs
\xn n'as tu pas entendu (parler) d'une jeune-fille qui serait sur une île
\xv kavwö jö nõõli-xa thòòmwa na khõbwe Mwani-mii ?
\dialx GOs
\xn n'as tu pas vu une certaine jeune-fille qu'on appelle Mwani-mi ?
\xv Na khõbwe cö trõne khõbwe ge-le-xa thoomwa xa Mwani-mii
\dialx GOs
\xn Si jamais tu entends dire qu'il y a une femme du nom de Mwańi-mi
...
\ge mais [GOs]
\re
\xv e kòlaadu-je xa e phu wîî-je
\dialx GOs
\xn il est maigre, mais il a de la force
\xv e khawali-je xa e kòlaadu-je
\dialx GOs
...
\ge que ; qui
\re
\xv êgu xa la ã-mi mõgu bwa vhaa i ã
\dialx GOs
\xn des gens qui sont venus travailler sur notre langue
\xv êgu xa li du-mi nyama vuli
\dialx PA
\xn personnes qui viennent traduire
\xv êmwê xa ti ?
\dialx GOs
\xn quel homme ?
\xv zixôô-nu ẽnõ êmwê xa a-xe xa yaaza-je Jae
\dialx GO
...
\xv e kõbwe xo/ko kêê-nu khõbwe e zo na jö cuxi na ni mõlõõ-jö
\dialx GOs
...
\dialx GOs
\xn je n'en n'ai ni entendu parler, ni ne l'ai vu(e)
...
\ge pour
\re
\xv e zo xo nu !, axe icö, cö zoma po-za mwa ?
\dialx GO
...
\xv ya-gòò-ra ? - ya-gòò mwa
\xn c'est la couverture de quoi ? - la couverture de la maison
\sn 2
\ps v
\ge couvrir (le toit d'écorce de niaoulis, ou de palmes de cocotier tressées)
\re
\cf yaa de-du
\ce couvrir de paille racines vers l'extérieur
\cf yaa-do mae
...
\re
\xv e za yaawa ui pexa pomõ-je ? ; e za yaawa pexa pomõ-je ?
...
\is cultures_champ
\ps n
\ge champ d'igname du chef (que l'on défriche)
...
\se yaa de-du
\sge couvrir de paille racines vers l'extérieur
\se yaado mae
\sge couvrir de paille racines vers l'intérieur
\se yagòò
\sge couvrir le toit de peaux de niaoulis ou de palmes de cocotier tressées
\cf phu
...
\re
\se ba-yazoo
\sge pierre à affûter, adze-blade
\xv e yazoo hèlè
...
\ps n
\ge monnaie
\dn D'après Charles, c'est une monnaie de chef, fine et noire, de haute valeur/ Elle est offerte attachée à un rameau de bois de fer, d'où le nom. Selon Dubois, un yòò de 50 cm vaut 100 fr). Hiérarchie des valeurs : yòò > weem > yhalo.
\re
...
\dialx GOs
\xn on ne sait pas quand ils arriveront
\xv nu a thraabu, novwu iju ca yhaamwa iju
\dialx GOs
...
\ps n
\ge monnaie kanak
\dn Selon Charles, monnaie de valeur moindre que "yòò" et "weem" ; mais de valeur équivalente à "pwãmwãnu"). Hiérarchie des valeurs : yòò > weem > yhalo.
\re
\dt 21/Feb/2019
...
\dialx GOs
\xn il s'est cheté un livre pour lui-même (=ponga-je)
\xv i khõôbwe vwo raa ije
\dialx PA
...
\is action
\ps v
\ge tailler en pointe ; épointer (un bout de bois)
\re
\xv e za mee ce
...
\sn 2
\is maison
\ge gaulettes qui retiennent la couverture du toit
\re
\se zabò mwa
\sge gaulettes
\cf orèi
...
\ps n
\ge gaulettes qui retiennent la couverture du toit
\dn La couverture du toit est faite d'écorce de niaouli et de paille.
\re
\dt 23/Feb/2019
...
\re repousse spontanée des plants
\ge glâner (des ignames, bananes, taros ) 
...
\ps n
\ge igname
\dn Selon Charles: c'est un clone à petites racines, planté sur le bord du billon. Ces ignames poussent plus vite que les ignames à racines longues du centre du billon et donnent les premières récoltes.
\re
\dt 21/Feb/2019
...
\dialx GOs BO
\xn l'igname est arrivée à maturité
\xv hãgana novwö e zeenô mwa kui
\dialx GOs
\xn maintenant que l'igname est mûre
\xv e zeenô phãgoo-je
\dialx GOs
...
\dialx BO
\xn ma fable ; mon conte
\xv higõõ-ny ã ciibwin ma amala-ò mèni
\dialx BO
...
\xv axe jena, e zo na e a-du ni we-za
\dialx GO
\xn Mais voilà, il faudra traverser la mer
\ng forme transitive en composition : v.t.-zoo-ni [GOs], v.t.-yoo-ni [PA]
\dt 24/Mar/2019
...
\xv nu tròòli ma nõ zò
\dialx GOs
\xn j'ai attrapé la gratte/la Ciguaterra
\dt 24/Mar/2019
...
\xv e zoma li ubò mõnõ ? - Hai ! kò (neg) li zoma ubò mõnõ, e zoma li yuu avwõnõ
\dialx GOs
...
\sn 2
\is santé
\ge intoxiqué par la Ciguaterra
\re
\xv nu zòn
\dialx PA
\xn je suis intoxiqué par la Ciguaterra
\xv ma zòn
\dialx PA
...
\dn Lors des naissances, on enveloppait le nourrisson dans l'écorce de niaoulis pour le protéger et lui donner de la force. Lors des décès, les feuilles et branches enveloppent la monnaie blanche qui autorise l'échange entre deux clans.
\se mû-zòòni
\sge fleur de niaoulis
\dt 29/Jan/2019

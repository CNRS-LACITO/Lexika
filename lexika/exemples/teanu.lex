...
\xn We took our tools down (from the ship) and brought them to build another boat.
\lf Cf.
\lv abu2
\el
\nt
...
\gn Food:3du
\rn their
\dn their: form of the possessive classifier used for food, tools, customary possessions etc. (fv:enaka*), with a 3 dual possessor (fl:see fv:da)
\rf
\xv mama ada
...
\gn Kin:2pl
\rn their
\dn their: form of the possessive classifier used for kin terms (fv:one*), with a 3 dual possessor (fl:see fv:da)
\rf
\xv et' ada
...
\gn Kin:3Pl
\rn their
\dn their: form of the possessive classifier used for kin terms (fv:one*), with a 3 plural possessor (fl:see fv:dapa)
\rf
\xv et' adapa
\xn their mother
\rf
...
\hn
\uv
\dn hesitation marker used when looking for one's words, fl:espec. before a noun
\rf
...
\sn 2
\hn esp
\dn bivalve shell, traditionally used as an instrument to grate (|fv{~lu}) coconut flesh or scrape the skin of tubers
\lf
\el POc
\et *kaRi
\nt
...
\dn small cowrie shell used as traditional money in some areas of Melanesia, though not in Vanikoro
...
\sn 2
\hn esp
\dn the sun in its course, insofar as it is taken as reference to assess the time of the day
\sd
\rf
...
\hn
\uv
\dn classificatory father: any male member of the parental generation (F, FB, FZH…) except the maternal uncle (MB = fv:gea)
\lf
\se
\ps intj
\wr B
...
\gn Food:2pl
\rn your
\dn your: form of the possessive classifier used for food, tools, customary possessions etc. (fv:enaka*), with a 2 plural possessor (fl:see fv:kaipa*)
\rf
...
\gn Kin:2pl
\rn your
\dn your: form of the possessive classifier used for kin terms (fv:one*), with a 2 plural possessor (fl:see fv:kaipa*)
\rf
...
\nq up (and do s.th.). A lively way to introduce a new action in a narrative, whether an upward movement is present or not. fl:Hence used as a clause linker: suddenly, then, without further ado
\rf
\xv
...
\gn Food:1in.pl
\rn our
\dn our: form of the possessive classifier used for food, tools, customary possessions etc. (fv:enaka*), with a 1st inclusive plural possessor (fv:kiapa)
\dn
\rf
...
\gn Kin:1in.pl
\rn our
\dn our: form of the possessive classifier used for kin terms (fv:one*), with a 1st inclusive plural possessor (fv:kiapa)
\dn
\rf
...
\gr
\ll shellfish for dugong
\dn small cowrie shell used as traditional money in some areas of Melanesia
\sc Conus musicus ceylanensis
\sd Sea
\el
\nt
...
\dn the seat of will and desire. The combination of fv:awa with |fv{~viaene}* ‘hit’, and/or with |fv{~ko} ‘say’, results in the meaning ‘want, like’
\rf
\xv Awa ene i-viaene tamwase!
\xn [my neck/mind hits it!] I absolutely love it!
\rf
\xv Awa kupa i-viane pi-ko u-le u-romo tadoe akapa.
\xn [our neck/mind hits says you go and see…] We'd like you to go and meet our god.
\rf
\rm
...
\sn 2
\hn euph
\dn a funeral ceremony taking place in the house of a recently dead person
\rf DG1-33b
\xv
\un Anth
...
\gr
\ge
\de *grille* de bambou tressé sur laquelle on pose de la nourriture pour la préserver ou la cuire
\gn shelf
\dn ‘almond shelf’: a shelf made of woven bamboo, hanging high over the fireplace in the kitchen, used for storing canarium almonds (fv:vongoro) while they dry
\rf DP1-2b
\rf
...
\xn The chief, together with elders and young boys, can go in the men’s club (vl:toplau); but women stay in their houses.
\lf Cf.
\lv toplau
\el
\nt
...
\un Etym.
\en This noun is metonymically named after the yearly flowering of the Erythrina flower (fv:ebieve1).
\lf
\el
\nt
\nq
...
\lv pie
\sn 1
\dn grandparent; anybody from the grandparent generation, whether male or female (FF, FM, MF, MM, MMZ, MMB…)
\rf
\xv epu iape
\xn his/her grandfather
\sn 2
\dn grandchild; anybody from the grandchild generation, whether male or female (SC, DC+)
\lf
\el
\nt
\nq
...
\rf
\un
\en Element found in several compounds: fv:mwatagete ‘boy (sg.)’, |fv{dapa gete} ‘boys (pl.)’, fv:mwagete ‘boy's clubhouse’.
\lf Cf.
\lv mwatagete
\el
\nt
...
\un
\en An instrument recently introduced from islands further west (fl:esp. Malaita). The sound is produced by striking (|fv{~abu}) the mouth of each tube with a beater made of wood or plastic.
\el ax:See
\et okoro
\nt
\dc 21/Feb/2010
...
\xn Genuine canoes have an outrigger.
\un
\en Although this verb is criticised as a loanword, it is frequently heard in informal speech. The equivalent in the vernacular would involve an existential predicate, usually with |vl{~wene}.
\lf
\el Pjn
\et garem
\el Eng
...
\xb He will do nothing but wander around everywhere in our country [ax:lit. wander ‘following our places’].
\rf
\xv La-tabe mata ka la-lui la-do i-katau ngogoro.
...
\dn go from inland towards the sea; go downhill; (at sea) move away from the island, towards the ocean
\lf Cf.
\lv teta-ke
\ln seawards
\sn 3
...
\dn take ‹s.th.› in order to use it fl:or move it. Serves to introduce a new participant in a situation, often an instrument or a theme, even when no actual ‘grabbing’ event is referred to.
\rf
...
\xn Last night [an earthquake ‘took’ & shook this house] this house was shaken by an earthquake.
\sn 4
\wn
\dn give ‹s.th.›
\rf
...
\xn I heard it with my own ears. It's the truth, I believe it.
\un Synt.
\en This construction consists of the verb |vl{~le} ‘go’ + the locative preposition vl:ne or locative adverb vl:ene.
\el (?) POc
\et *lako
\nt
\nq
...
\xn With your (opp.-sex) cross-cousin, you are not allowed any body contact.
\un Anth
\en Any sort of contact between cross-cousins of opposite sex, whether eye- or body-contact, is strictly prohibited. If it ever occurs, then the two individuals must marry. As a consequence, cross-cousins – who can be potentially spouses – avoid each other strictly.
\lf
\el
\nt
\nq
...
\ee This village is also known, in the literature, under the names Vanou or Whanou (Dillon). Its local name, in the language Lovono, is vl:Vana.
\lf
\el
\nt
\nq
...
\ge râper
\gn grate
\dn scrape ‹tuber› fl:or grate ‹coconut flesh›, with a bivalve shell (fv:aero2) or grater
\rf DG1-34b
...
\xb The French came here to collect people and take them away, with the intention to make them work for them.
\lf
\el
\nt
\nq
...
\rf DG2-16a
\un Anth
\en Vanikoro people used to trade the red feathers of this little bird with other islands of the Santa Cruz archipelago. They were then transformed into customary money.
\so
\nt BTA = this bird provided red feathers which were traded to Santa Cruz to make the feather money used traditionally on Santa Cruz as dscribed by Bill Davenport in Scientific American etc.
\bb Davenport (1971)
\lf
\el
\nt
...
\dn ‘famine food’: plant which is not ordinarily used as a staple, yet which is known to be edible enough to be consumed in case of crop shortage or disaster
\sn 2
\hn meton
...
\gn talk
\uv human
\dn talk, utter words, considered as a general faculty (fl:vs |fv{~vete piene} ‘say s.th.’)
\rf
\xv I-mui pe i-mo.
\on disabled child
\xn He cannot speak.
...
\gr toko strong
\ll talk strong
\dn speak with a firm tone of voice, fl:esp. in giving a lesson or firm advice; fl:hence reprimand (s.o., fv:se)
\rf
...
\ll Devils' lair
\hn
\dn place (fl:typic. cave) haunted by spirits or deities; fl:hence heathen temple
\rf
\xv Ka ponu li-la viko, li-lui li-lateli ne moe ma tadoe.
\xn They took the shell-money, and put it down in the gods' lair.
\ue Ethn
\ee Ancestral priests are represented as visiting this place to worship their gods and send imprecations.
\el
\nt
\nq
\dc 15/Nov/2009
...
\ge
\gn
\dn a sturdy, round wooden mortar used in cooking, fl:esp. to pound taros and Canarium almonds (|fv{vongoro}) during the preparation of the pudding (fv:mama2)
\rf
...
\xn The elders very often use this expression “it's wonderful”: they find it a nice [ax:lit. heavy] word. Whereas a word like “alright” is a bit too common. [it's light]
\lf
\el
\nt
\nq
...
\ps n
\gr
\dn by analogy of shape with the centipede (fv:nuduro1), designates various artefacts characterised by their length
\rf
\sn 1
...
\lf
\el
\nt I hear "Ñivale" in the tape, and this is also the form used by Ezzy in his emails. However a bunch of kids were correcting the form to "Ñilale" with /l/.
\dc 17/May/2012
\dt 18/May/2012
...
\ge festival
\gn festival
\dn dance festival. People feast for several days, and dance by stomping on boards (vl:tepapa), laid out on the ground in a circle around a ritual pole (vl:blateno)
\sd Ethn
\rf
\xv li-vete ngapiene
...
\lf
\tn |{tab}|fb{The dance festival} £ |{tab}[|vl{ngapiene}*] |vl{xxx.} |fs{‘xxx.’}
\se ~mini ngapiene
\ps voi
\gr
\ll give festival
...
\un
\en The combination of the verb |vl{~la} ‘take’ and vl:ngatene ‘things’ results in the meaning ‘to work’.
\lf Cf.
\lv ~langatene
\el
\nt
...
\rf
\xv li-wete otovo
\xn [ax:lit. pin sago] put together a set of sago leaves, in preparing the roofing (|ax{see} |vl{wete}*)
\lf Syn.
\lv uie otovo
\ln sago leaves
\sn 3
...
\sn 1
\gn sea
\dn sea, fl:esp. marine zone surrounding the island and accessible on a daily basis (fl:vs. fv:ngamuli ‘ocean’)
\sd
\rf
\xv abilo peini revo
\xn seasnake
...
\el
\nt
\nq BTA gives another Sp for this name!!  and also another name for this Sp!! (samwaele) ==> je corrige d'après BTA + étymologie
\dc 28/Nov/2009
\dt 09/May/2010
...
\ge tenir
\gn hold
\dn carry ‹s.o., s.th.› above o.'s belt, |fl{i.e.} in o.'s arms fl:or on o.'s shoulders
\rf
...
\un Morph.
\en The particle occurs at the same place as the auxiliary-like verb form |vl{~tabo}, except that it does not take verbal prefixes.
\el
\nt
\nq
\dc 20/Nov/2009
...
\uv s.o.
\dn be: be in such and such a condition, whether temporarily or permanently
\rf
\xv A-te moli?
\xn Are you free?
\rf
...
\ge
\gn
\dn k.o. seashore tree, whose hard wood is used for several artifacts, incl. fv:tekumete2
\sc Pemphis acidula
\sd Bot
\rf DG2-12a
\lf
...
\uv man
\dn require official engagement (to a woman, |fv{ñe}/|fv{se}) from her family
\rf DP1-31b
...
\hn esp
\uv
\dn stomping boards. During vl:ngapiene festivals, a vl:blateno pole is erected in the middle of the village area (fv:mane). Laid out in circle (fv:~dai, fv:~dadai) around it, are a number of wooden boards half buried (fv:~iu2) in the ground, on which dancers leap and stomp (|fv{~viaene}, |fv{~wate}) during the celebrations, in a loud and joyful dance.
\sd Ethn
\rf Tamate.114
...
\ge nasse
\gn trap
\dn small wicker basket used as a bottle trap, plunged (fv:~re2) in a river to catch prawns or shrimps (fv:konge)
\sd Techn
\rf d11.Wora:17
\xv Kape la-re tetaki me la-labu neido konge ne ero.
...
\sd Kin
\gr brata
\dn sibling: irregular form of |fv{tilio}* for 3sg (‘his/her sibling’) and when followed by a noun (‘sibling of X’)
\rf
\xv Tilio, we tieli?
...
\xn They went to pick various fruits, such as breadfruit, chestnuts, lychees…, and they brought them.
\lf
\el POc
\et *puaq
\nt
...
\ge élever
\gn raise
\dn Causative counterpart of |fv{~vene} ‘go up’, fl:hence raise, put up ‹s.th.›
\sn 1
...
\ge
\gn
\dn a membranophone drum, not native from Vanikoro, but found in islands further West
\sd Mus
\rf DG1-45a
\un Etym.
...
\sn 5
\hn slg
\dn fix ‹a girl›: arrange a romantic relationship with ‹a girl› on behalf of s.o.
\rf DP1-32a
...
\xn When you hunt [ax:lt. shoot] pigeons, you bend your bow, and let the arrow fly and hit it.
\sn 3
...
\xn Cyrtosperma taros, we dig them out with the digging stick, and take them home.
\rf cf. DP1-26a
\un Techn
\en Alocasia taros (vl:vioe) are harvested by digging (fl:Cf. fv:~ae2); whereas Colocasia taros (vl:jebute) are harvested by pulling (fl:Cf. fv:~au1).
\sn 6
\wn in cooking
\dn pound ‹taros, almonds+› in a bowl, using a long and heavy pestle
\rf
\xv I-tau jebute moioe ponu, i-loko i-ka i-le ne monone ka i-wete. I-wete awoiu ka i-ejau mama ada.
\xn Once the taro was cooked, she put it in a bowl and began to pound it. When she finished pounding it, she made the pudding.
\rf
\xv Li-wete jebute li-wete vongoro awoiu pon, li-ejau mama.

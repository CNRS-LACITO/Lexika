            ...
            "personnalisé Alex": {
                ...
                "entités": {
                    ...
                    "sens littéral": {"entités": [{"nom": "sens littéral", "attributs": {"sens littéral": None}, "structure": {}}],
                                   "parents": [{"nom": "sous-entrée", "attribut": "sens littéraux"},
                                               {"nom": "sens", "attribut": "sens littéraux"},
                                               {"nom": "groupe", "attribut": "sens littéraux"},
                                               {"nom": "entrée", "attribut": "sens littéraux"}]},
                    ...
                    "note": {"entités": [{"nom": "note", "attributs": {"note": None}, "structure": {}}],
                             "parents": [{"nom": "sous-entrée", "attribut": "notes"},
                                         {"nom": "sens", "attribut": "notes"},
                                         {"nom": "groupe", "attribut": "notes"},
                                         {"nom": "entrée", "attribut": "notes"}]},
